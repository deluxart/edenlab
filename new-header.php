...
<head>
	...
	<meta name="google-site-verification" content="3Okz_YsdiEJsLZ4G5wcunDgs1iqjnzPm_xrNHAj_KhA" />

	<?php wp_head(); ?>
    <?php if (get_field( 'google_tag_manager', 'option' )) { the_field( 'google_tag_manager', 'option' ); } ?>
    <style>
        .grecaptcha-badge { visibility: hidden; }
        .agree, .agreesubscribe { display: none; }
		.wp-block-code { max-height: 300px; overflow: auto; }
    </style>
</head>

<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<?php if (get_field( 'google_tag_manager_noscript', 'option' )) { the_field( 'google_tag_manager_noscript', 'option' ); } ?>
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'edenlab' ); ?></a>

    <header id="header" class="<?php the_field( 'header_color' ); ?> <?php if ( is_singular( 'product' ) || is_404() || is_page_template('coming-soon.php') ) { ?>blue<?php } ?><?php if (is_page_template('page-crm-home.php')) {?> dark<?php } ?>">
        <div class="container">
            <div class="content">
...
<!--                            </ul>-->
<!--                        </li>-->
<!--                        <li class="external"><a href="https://crm.edenlab.io/" target="_blank">CRM Implementation</a></li>-->
                    </ul>
                    <?php } ?>
                    <a href="#feedback" class="btn">
                        <span>Contact experts</span>
                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.5555 7.99985L16.4394 8.88374C16.9276 8.39558 16.9276 7.60413 16.4394 7.11597L15.5555 7.99985ZM7.95412 2.16622L14.6716 8.88374L16.4394 7.11597L9.72189 0.398456L7.95412 2.16622ZM14.6716 7.11597L7.60057 14.187L9.36833 15.9548L16.4394 8.88374L14.6716 7.11597ZM15.5555 6.74985H-0.00083071V9.24985H15.5555V6.74985Z" fill="white"/>
                        </svg>
                    </a>
                </div>
                <div class="nav_icon">
