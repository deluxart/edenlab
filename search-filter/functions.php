...
function edenlab_scripts() {
    ...
    wp_enqueue_style( 'edenlab-styles', get_template_directory_uri() . '/styles/style.css', array(), '21212121' );
//    wp_enqueue_style( 'edenlab-blocks', get_template_directory_uri() . '/blocks/blocks.css', array(), '323230123998' );
    ...
    wp_enqueue_script( 'edenlab-main', get_template_directory_uri() . '/js/main.js', array(), '33333', true );
